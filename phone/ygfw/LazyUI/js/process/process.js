lazy.plugins.process = {
    "init" : function(el,data) {
        ...
        //录音
        var soundobj = {};
        var table = lazy.create("div","table ub ub-ver");
            ...
            function tableFun(arr, n) {
                for(var i = 0; i < arr.length; i++) {
                    ...
                    if(type == "datetime" || type == "date" || type == "time"){
                        // if(pe.getElementsByClassName("datetimeinput")[0].innerHTML!=""){
...
//                        }
        ...
        function fileone(h1, h2, path) {
            var filekuang = lazy.create("div","filekuang ub");
            var icon = lazy.create("div","icon");
            var td = lazy.create("a","td ub-f1");
            if(h2 > 0) {
        ...
        function dateFun(obj, zuindex, bs) {
            ...
            _html += '<div class="inputdiv ub-f1"><div class="datetimeinput" value="" type="'+type+'">'+(obj.placeholder?obj.placeholder:"")+'</div></div>';
            _html += '</div>';
            tr.innerHTML = _html;
        ...
        function overtimeFun(obj, zuindex, bs) {
            ...
            tr_overtime.onclick = function() {
                lazy.setParameter("iframeBack","overtime");
        ...
        function mapFun(obj, zuindex, bs) {
            ...
            tr_map.onclick = function() {
                lazy.setParameter("iframeBack","map");
                iframe.src = obj.url;
                iframe.style.left = "0";
                iframe.style.webkitAnimation = "peopleIframe_an 0.5s";
            }
        ...
        function soundFun(obj, zuindex, bs) {
            ...
            var sounddiv = lazy.create("a","sounddiv");
