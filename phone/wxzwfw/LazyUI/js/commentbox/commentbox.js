lazy.plugins.commentbox = {
	"init" : function(el,data) {
	    ...
	    if(!data.send) {
            ...
            var btn1 = lazy.creat("div", "btn");
            btn1.appendChild(iconbtn("pingbtn",data.ping));
            ...
            function iconbtn(name, val) {
                ...
                iconbtn.innerHTML = '<div class="ub-f1"></div><div class="iconbtn1 '+name+'"></div><div class="iconbtntitle"><span>'+(val?val:0)+'</span></div><div class="ub-f1"></div>';
                return iconbtn;
            }
