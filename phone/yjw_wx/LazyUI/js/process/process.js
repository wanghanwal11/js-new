...
//                             
        ...
        function getIdCard(i,str,kuang){
            lazy.startPhoto(function(pics, upids) {
                //var icondiv = lazy.create("div","idcardimg");
        ...
        function mapFun(obj, zuindex, bs) {
            ...
            _html += '  <input class="slh ub-f1 sprtitle gpss" placeholder='+(obj.title?obj.title:"")+'></input>';
        ...
        function soundFun(obj, zuindex, bs) {
            ...
            var tr = lazy.create("div",bs + " tr");
            var _html = '';
            _html += '<div class="tr_input ub tr_sound">';
            _html += '  <div class="slh ub-f1 sprtitle"><span>'+(obj.title?obj.title:"")+'</span></div>';
            _html += '</div>';
            tr.innerHTML = _html;
            var sprtitle = tr.getElementsByClassName("sprtitle")[0];
            var sounddiv = lazy.create("div","sounddiv");
            var luyin = lazy.create("div","luyin");
