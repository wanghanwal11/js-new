...
//                             
        ...
        function clickFun(obj, zuindex, bs) {
            ...
            _html += '<div class="inputdiv box_f1"><input type="text" readonly="readonly" value="'+vl+'"placeholder="'+(obj.placeholder?obj.placeholder:"")+'"/></div>';
            _html += '</div>';
            tr.innerHTML = _html;
            tr.onclick = function(){
        ...
        function idCardFun(obj,zuindex,bs){
            ...
            for(var i = 0;i<remardarr.length;i++){
                ...
                kuang.innerHTML = "<div class='remind'>"+remardarr[i].substring(0,3)+"</div>";
