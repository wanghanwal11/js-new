lazy.plugins.jfheader = {
	"init" : function(el,data) {
		...
		html+='<div class="jf"><div class="left">第<span class="left1">&nbsp;&nbsp;</span>名</div><div class="center"></div><div class="right">总计<span class="right1">&nbsp;&nbsp;</span>分</div></div>'
        ...
        data.setc=function(peopleimg,count,num){
            if(count&&num){
                ...
                el.getElementsByClassName("left1")[0].innerHTML=count;
