...
PAGE_INIT = function(parent) {
        ...
        function showChart(orgid) {
            var urls = [
                     {
                        chartid: 'gqyldrk_chart',
                        url:urlConfig.gqyldrk + 'tablename=rlt_floating_lowerflowpeople&orgid=' + orgid
                     },{
                        chartid: 'btnljdldrkbl_chart',
                        url:urlConfig.btnljdldrkbl + 'tablename=rlt_floating_agestage&orgid=' + orgid
                     },{
                        chartid: 'ldrkwhcdbl_chart',
                        url:urlConfig.ldrkwhcdbl + 'tablename=rlt_floating_edu&orgid=' + orgid
                     }
            ];
            var k = 0;
            function one() {
        ...
        chartInit(function() {
            ...
            leftNav,
            {
                ...
                list : [{
                    ...
                    title : '热力图分析',
                    onclick : function() {
                        lazy.openWin('#lingdaotong/amap?tablename=rlt_floating_hot&orgid='+org_id);
                    }
                }]
            },{
                id : 'gqyldrk_chart',
