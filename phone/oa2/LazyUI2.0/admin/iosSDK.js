...
lazy.previewImage = function(obj) {
       obj=obj||{};
       window.webkit.messageHandlers.previewImage.postMessage({
           body:obj
       });
}
//上传图片接口
lazy.uploadImage = function(back,obj) {
       var funname = lazy.callBackFun(back);
       obj=obj||{};
       obj.success=funname;
...
//显示本地图片
lazy.getLocalImgData = function(back,obj) {
       var funname = lazy.callBackFun(back);
       obj=obj||{};
       obj.success=funname;
       window.webkit.messageHandlers.getLocalImgData.postMessage({
           body:obj
       });
}
//下载图片接口
lazy.downloadImage = function(back,obj) {
       var funname = lazy.callBackFun(back);
       obj=obj||{};
       obj.success=funname;
