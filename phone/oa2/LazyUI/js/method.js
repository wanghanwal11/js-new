...
!function(){
    var Lazy = function() {
        ...
        //iframe返回
        this.iframeBack = iframeBackFun;
        //获取事件
        this.getDate = getDateFun;
    }
     /*///////////////////////////////////////////////////////////////////
    *   内置方法和变量可以直接使用
    ...
    */
   //
    function getDateFun(type,back){
        var funname = lazy.callBack(back);
    }
    function iframeBackFun(){
    ...
    function startSoundFun(uploadurl,back){
        
    }
    function goAdminFun(){
        
    }
    function getPersonFun(){
    ...
    function bounceFun(obj) {
        ...
        if(el && lazy.browserType=="vitoios") {
    ...
    var docEl = document.documentElement;
        ...
        lazy.fontSize = 40 * (clientWidth / 720);
        docEl.style.fontSize =  lazy.fontSize + 'px';
    }();
}();