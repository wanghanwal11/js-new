    ...
    "init" : function(el,data) {
                ...
                for(var i = 0; i < arr.length; i++) {
                    ...
                    if(type == "datetime" || type == "date" || type == "time" || type == "month"){
                        ...
                        if(arr[i].bol=='true'){
                            ...
                            arr[i].value = _span.value&&_span.value!=arr[i].placeholder?_span.value:"";
        ...
        function selectFun(obj, zuindex, bs,bol) {
            if(bol&&bol==true){//处理select兼容
                ...
                if(obj.value){
                    _html += '<input type=text readonly class="inpo"  placeholder='+obj.value.value+' >';
                }else{
                    _html += '<input type=text readonly class="inpo"  placeholder='+obj.placeholder+' >';
                }
                ...
                select1.onclick=function(){
                    lazy.alertlist(obj.option,function(item){
                        ...
                        if(obj.select) obj.select(ht,item.value);
                    })
                ...
                _html += '<div class="title hh"><span>'+(obj.title?obj.title:"")+'</span></div>';
                _html += '<div class="inputdiv ub-f1">';
                _html += '<select class="select"  '+(obj.readonly||'')+'>';
        ...
        function dateFun(obj, zuindex, bs) {
            ...
            _html += '<div class="inputdiv ub-f1"><div class="datetimeinput" str="'+str1+'" value="1" type="'+type+'">'+(obj.placeholder?obj.placeholder:"")+'</div></div>';
            _html += '</div>';
            tr.innerHTML = _html;
