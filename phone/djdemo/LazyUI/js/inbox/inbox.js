    ...
    "init" : function(el,data) {
        ...
        function one(obj) {
           ...
           icon.style.marginLeft="0.5rem";
            if(obj.status=="0"){
                 //_html += '<div class="sf"></div>';
                 var sf = lazy.creat("div","sf");
                 tr1.appendChild(sf);
                }else{
                 //_html += '<div class="st"></div>';
                 var st = lazy.creat("div","st");
                 tr1.appendChild(st);
                }
           var _html = '';
               ...
               if(obj.status=="0"){
                   _html += ' <div class="name ub-f1"><span class="span3 addfj">'+(obj.name?obj.name:"")+'</span></div>';
               }else{
