lazy.plugins.pinglist = {
	"init" : function(el,data) {
	    if(data.title) {
            ...
            title.innerHTML = '<div class="kuai"></div><div class="ub-f1"><span class="xiugai">'+data.title+'</span></div><a class="more"><span>更多评论...</span></a>';
        ...
        data.one=one;
        if(data.title){
            var ti=el.getElementsByClassName("xiugai")[0];
            data.xiugai=function(str){
                ti.innerHTML=str;
            }
        }
