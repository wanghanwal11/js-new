		...
		for(var i = 0; i < arr.length; i++) {
            ...
            for(var j = 0; j < answer.length; j++) {
                ...
                if(arr[i].cuowu.bol){
                    ...
                    //
                    if($(this).hasClass('td_zq')){
                        $(this).removeClass('td_zq')
                     }else{
                          this.className = "td hh tdzq td_zq";
                     }
                     var td_zq=pel.getElementsByClassName("td_zq")
                     var allval=[];
                     for(var i=0;i<td_zq.length;i++){
                         allval.push(td_zq[i].getAttribute("value"))
                     }
                       pel.setAttribute("value",allval);
