var config = {
     'oa' : {
        "filedelete": getIP() + "/oa/docmobile/delbyid.ht?",//删除文件
        "fileupload": getIP() + "/oa/docmobile/docupload.ht?", //上传url
        "fileupload1": getIP() + "/oa/docmobile/docupload1.ht?", //上传url1
        "addressMobile":getIP()+"/oa/address.ht",
        "uppwdMobile":getIP()+"/oa/sysmolile/uppwd.ht?",
        "delfile":getIP()+"/oa/docmobile/delbyid.ht?id=",
    },
    //登录
...
var djconfig={
    ...
    "zbhdlb" : getIP() + "/basicactivities/Activity_Base/listMobileByPartyid.ht?",
     ...
     "shykxq": getIP()+"/party/DJ_SanHuiYiKe/get.ht?",
      //三会一课f会议相关
     "hyxg": getIP()+"/party/DJ_SanHuiYiKe/getFile.ht?",
     //三会一课会议人员
    ...
    //我的搜索活动
     ...
     //缴纳党费
     "dfjn":getIP() + "/party/DJ_PartyPayDues/save.ht?",
      //缴纳党费记录
     "dfjl":getIP() + "/party/DJ_PartyPayDues/myList.ht",
     //缴纳党费审核
     "dfsh":getIP() + "/party/DJ_PartyPayDues/auditListForMobile.ht?",
     //提交党费审核
     "submitsh":getIP() + "/party/DJ_PartyPayDues/updatePayState.ht?",
     //获取验证码
     "yanzheng":getIP() + "/sys/vitoregister/updateAccount.ht?",
     //党史上的今天
     "ds":getIP()+"/party/DJ_HistoryToday/getHTforMobile.ht",
     //党史上的今天详情
     "dsxq":getIP()+"/party/DJ_HistoryTodayRecord/get.ht?",
}
